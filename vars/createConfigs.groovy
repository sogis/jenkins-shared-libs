def call(String environment, String dbuser,String dbuserpwd, String dbserver, String dbname, String configFileName, String serviceName) {
    sh """
        ...
        java -jar sql2json-1.1.20.jar -c jdbc:postgresql://${dbserver}:5432/${dbname} -u ${dbuser} -p ${dbuserpwd} -t api_webgisclient/sql2json/templates/${serviceName}/${configFileName} -o ${configFileName} -s https://raw.githubusercontent.com/qwc-services/qwc-${serviceName}/master/schemas/qwc-${serviceName}.json
        mkdir config
