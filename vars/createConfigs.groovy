def call(String appName, String namespace, String configFileName) {
    sh """
        ...
        oc create configmap $appName --from-file=$env.WORKSPACE/config/$appName/$configFileName -n $namespace
        oc create configmap $appName --from-file=$env.WORKSPACE/config/permissions.json -n $namespace
    """
